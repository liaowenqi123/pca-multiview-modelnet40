"""
v1: ResNet50 + 3-View 推理脚本。
输出 result.json → result.zip
"""
...
from common import MultiViewResNet, NUM_CLASSES

ROOT_DIR = Path(__file__).resolve().parent.parent
CHECKPOINT_PATH = ROOT_DIR / "checkpoints" / "v1" / "best_model.pth"


def preprocess(points):
    aligned = pca_align(points)
    views = project(aligned, num_views=3, grid_size=GRID_SIZE)
