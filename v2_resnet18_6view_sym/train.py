"""
v2: ResNet18 + 6-View Symmetric Fusion 训练脚本。
"""
...
CHECKPOINT_DIR = ROOT_DIR / "checkpoints" / "v2"


def main():
    parser = argparse.ArgumentParser(description="v2: ResNet18 + 6-View Symmetric Fusion")
    ...
    # ── 训练 ──
    print(f"\n{'='*60}")
    print(f"v2 ResNet18+6View SymFusion | {args.epochs} epochs | bs={args.batch_size} | lr={args.lr}")
    print(f"{'='*60}\n")
