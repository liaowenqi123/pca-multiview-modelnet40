...
def main():
    ...
    parser.add_argument("--d_attn", type=int, default=64, help="点云自注意力维度")
    parser.add_argument("--d_pointnet", type=int, default=128, help="PointNet 特征维")
    parser.add_argument("--d_kv", type=int, default=64, help="交叉注意力 K/V 维")
